const fs = require('fs');
fs.mkdirSync('C:/brainpool-clean/brainpool-clean/app/api/chat', { recursive: true });
...
fs.writeFileSync('C:/brainpool-clean/brainpool-clean/app/api/chat/route.ts', route, 'utf8');
console.log('완료');
